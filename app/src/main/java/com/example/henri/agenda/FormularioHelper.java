package com.example.henri.agenda;
...
public class FormularioHelper {
    ...
    public void carregaImagem(String caminhoFoto) {
        if(caminhoFoto != null) {
            Bitmap bitMapImage = BitmapFactory.decodeFile(caminhoFoto);
            Bitmap imagemReduzida = Bitmap.createScaledBitmap(bitMapImage, 300, 300, true);
